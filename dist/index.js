 ...
 */
let planets = [];
function savePlanet(name, coordinates, situation, satelites) {
    let planet = {
        name,
        coordinates,
        situation,
...
function updateSituation(planetName) {
...
function addNewSatelite(sateliteName, planetName) {
    let resultPlanet = searchPlanet(planetName);
    if (resultPlanet) {
        resultPlanet.map(planet => {
...
function removeSatelite(planetName) {
    let resultPlanet = searchPlanet(planetName);
    if (resultPlanet) {
        resultPlanet.map(planet => {
